...
export const AuthCard = ({ logo, children }) => (
    <div className="min-h-screen flex flex-col sm:justify-center md:justify-center  items-center pt-6 sm:pt-0 bg-gray-100">
        <div>{logo}</div>
...
export const AuthSessionStatus = ({ status,  ...props }) => (
    <>
        {status && (
            <div
...
export const Input = ({className='',  ...props }) => (
    <input
        ...
        className={`${className} rounded-md shadow-md border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50`}
        {...props}
    />
)
...
export const NavLink = ({ active = false, children, ...props }) => (
    <Link {...props}>
        <a
...
export const ResponsiveNavLink = ({ active = false, children, ...props }) => (
    <Link {...props}>
        <a
